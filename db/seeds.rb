...
CATEGORIES.each_with_index do |category, index|
  ...
  CAREERS[index].each do |career|
    ...
    male_user = User.new(
      ...
      birth: "",
      user_description: Faker::Company.name + " " + Faker::Company.industry,
    ...
    pro = Professional.new(
      location: "",
      specialty: Faker::Educator.university + ' ' + car.title,
      experience_in_years: rand(1..10),
      resume: "",
  ...
  #   last_name: Faker::Name.last_name,
  #   birth: "",
  #   user_description: Faker::Educator.university + ', ' + car.title + ' degree.',
  #     # user_description: Faker::Educator.university + ", " + Faker::Educator.degree,
  #     avatar: "https://randomuser.me/api/portraits/female/#{rand(1..99)}.jpg",
  #     password: 123456
  #     )
